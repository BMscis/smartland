...
import { ReactComponent as Logo } from "../../assets/sas.svg"
import {
  Link,
  useNavigate,
  useMatch,
    ...
    <>
      ...
      <header id="myHeader" className='navbar white'>
        <div className='container'>
          <NavLink to="/">
            <Logo style={{transform:isMobile() ? "scale(.5)" : "scale(1)"}}/>
          </NavLink>
          <div className='row w-100-nav'>
            <div className='logo px-0'>
              <div className='navbar-title navbar-item'>
                <NavLink to="/">
                  {isMobile() && user ? (
                    <>
                       <h3 style={{visibility:"hidden"}}>SMARTSEAT</h3>
                    <h4 style={{visibility:"hidden"}}>BLOCKCHAIN TICKETS</h4>
                    </>
                  ) : <>
                    <h3 style={{transform:isMobile() ? "scale(.8)" : "scale(1)"}}>SMARTSEAT</h3>
                    <h4 style={{transform:isMobile() ? "scale(.65)" : "scale(1)"}}>BLOCKCHAIN TICKETS</h4>
                  </>
            ...
            {user &&
              <div className='mainside'>
                <NavLink to="/wallet" className="btn-main" style={{ display: token ? "none" : "block" }}>Connect Wallet</NavLink>
                <div className="logout" style={{ display: token ? "flex" : "none" }}>
                  ...
                  <div id="de-click-menu-profile" className="de-menu-profile" onClick={() => btn_icon_pop(!showpop)} ref={refpop}>
                    <img src={user.photo.url} alt="" style={{
                      pointerEvents: "none"
                    }} />
                    {showpop &&
                      <div className="popshow">
                        ...
                        {wallt &&
                          <>
                            ...
                            <div className="d-wallet">
                              <h4>My Wallet</h4>
                              <span id="wallet" className="d-wallet-address">{wallt.Account}</span>
                        ...
                        <ul className="de-submenu-profile">
                          <li>
                            <span onClick={() => { navigate(`/Author/${user.user}`) }}>
                              <i className="fa fa-user"></i> My profile
                            </span>
                          </li>
                          <li>
                            <span onClick={() => { navigate(`/Profile/${user.user}`) }}>
