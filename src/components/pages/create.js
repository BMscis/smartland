...
class Createpage extends Component {
  ...
  async sendToAWS() {
    try {
      ...
      this.context.setErrorState({
        state:true,error:error.message
      })
      return false
    }
  }
  ...
  async deploy() {
    ...
    try {
      ...
      if(!res) return
      const price = this.context.stdlib.parseCurrency(
        parseInt(this.state.event.item_price)
      )
      ...
      this.eventObject = {
        tickets, eventName, price, eventSymbol, url, metadata, evenTime, reserved
      }
  ...
  async notify(ctx, tkn, sup, bal) {
    ...
    } catch (error) { console.log("TOKEN ACCEPT ERROR: ", error) }
    this.setState({
      ...this.state,
  ...
  async ready() {
    ...
    if(nft && cr){
      this.setState({
        ...this.state, loading: false,newNFT:true
      })
    }
  }
  addArtist() {
    const count = this.state.artistCount
    this.setState({
      ...this.state,
      artists: [
        ...this.state.artists, Artist
      ]
    })
  }
  onChange(e) {
          ...
          <div id="tabs2">
            ...
            >
                        ...
                        <div className="field-set">
                          ...
                          <div className="d-create-file">
                            ...
                            <div className='browse'>
                              ...
                              <input required id='upload_file' accept="image/png, image/jpeg" type="file" multiple onChange={this.onChange} />
                            </div>
                          </div>
              ...
              <Tab eventKey="Artist" title="Artist">
                <section className='container' style={containerStyle}>
                  <div className="col-lg-4 col-md-6 demo-icon-wrap" style={{
                    position: "absolute",
                    top: 0
                  }}>
