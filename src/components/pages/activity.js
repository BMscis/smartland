        ...
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <ul className="activity-filter">
              <li id="sale" className="filter_by_sales" onClick={handleBtnClick2}>
                <i className="fa fa-shopping-basket"></i>Sales
              </li>
              <li id="like" className="filter_by_likes" onClick={handleBtnClick3}>
                <i className="fa fa-heart"></i>Likes
              </li>
              <li id="offer" className="filter_by_offers" onClick={handleBtnClick4}>
                <i className="fa fa-gavel"></i>Offers
              </li>
              <li id="follow" className="filter_by_followings" onClick={handleBtnClick1}>
